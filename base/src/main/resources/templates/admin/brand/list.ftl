                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <#if pageBean.content?size gt 0>
                                            <#list pageBean.content as brand>
                                                <tr>
                                                    <td style="vertical-align:middle;">
                                                        <label class="lyear-checkbox checkbox-primary">
                                                            <input type="checkbox" name="ids[]" value="${brand.id}"><span></span>
                                                        </label>
                                                    </td>
                                                    <td style="vertical-align:middle; width: 15%">${brand.getName()!""}</td>
                                                    <td style="vertical-align:middle; width: 50%" >${brand.getInfo()!""}</td>
                                                    <td style="vertical-align:middle;" style="vertical-align:middle;"><font class="text-success">${brand.createTime}</font></td>
                                                </tr>
                                            </#list>
                                        <#else>
