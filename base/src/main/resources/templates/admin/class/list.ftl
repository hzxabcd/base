...
<head>
    ...
    <title>${siteName!""}|分类管理-${title!""}</title>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <#if pageBean.content?size gt 0>
                                            <#list pageBean.content as class>
                                                <tr>
                                                    <td style="vertical-align:middle;">
                                                        <label class="lyear-checkbox checkbox-primary">
                                                            <input type="checkbox" name="ids[]" value="${class.id}"><span></span>
                                                        </label>
                                                    </td>
                                                    <td style="vertical-align:middle; ">${class.getName()!""}</td>
                                                    <td style="vertical-align:middle;" style="vertical-align:middle;"><font class="text-success">${class.createTime}</font></td>
                                                </tr>
                                            </#list>
                                        <#else>
