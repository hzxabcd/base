...
import com.xuan.base.dao.admin.DatabaseBakDao;
import com.xuan.base.entity.admin.DatabaseBak;
...
public class DatabaseBakService {
	...
	@Value("${xuan.database.backup.dir}")
	private String backUpDir;
	@Value("${xuan.database.backup.username}")
	private String dbUsername;
	@Value("${xuan.database.backup.password}")
	private String dbPwd;
	@Value("${xuan.database.backup.database.name}")
